...
public class A1 extends JFrame {
    ...
    * @return toolsPanel        the Panel
    ...
    public JPanel setUpToolsPanel() {
        ...
        ImageIcon shapeButtonIcon = createImageIcon("3D.png");
        shapesComboBox = new JComboBox<ImageIcon>(new ImageIcon[] {ovalButtonIcon,recangletButtonIcon,squareButtonIcon,spatternButtonIcon, pieButtonIcon,shapeButtonIcon,} );
