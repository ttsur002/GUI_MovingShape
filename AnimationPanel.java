...
public class AnimationPanel extends JComponent implements Runnable {
	...
	shapes = new ArrayList<MovingShape>(10); //create an array to store shapes
    ...
    protected void createNewShape(int x, int y) {
        ...
        switch (currentShapeType) {
            ...
            case 5: {
                shapes.add(new Moving3D(x, y, currentWidth,currentHeight, marginWidth, marginHeight, currentBorderColor, currentFillColor, currentPath));
                count++;
                break;
            }
       }
